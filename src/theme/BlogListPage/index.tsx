...
function ViewTypeSwitch({
  ...
  return (<div className="bloghome__swith-view">
    <Icon
        icon="ph:list-fill"
        width="24"
        height="24"
...
function BlogPostGridItems({items}: BlogPostItemsProps): JSX.Element {
  return (<>
    {items.map(({content: BlogPostContent}, index) => {
      ...
      return (<div className="post__list-item" key={blogMetaData.permalink}>
...
function BlogRecommend({
  ...
  return (<>
    <div className="container-wrapper">
      ...
      >
        {!isPaginated && (<h2 className="blog__section-title">
            ...
            <div className="bloghome__posts">
              <ul className="blog__recommend">
                <Fade direction="up" duration={800} triggerOnce={true}>
                  {recommendedPosts.map(post => (<li className={clsx('card')} key={post.permalink}>
                    {post.frontMatter.image && (<div className={clsx('card__image')}>
                      <Image
    ...
    <div className="container-wrapper">
      ...
      >
        ...
        <div className="row">
          ...
          >
            <div className="bloghome__posts">
              {(isListView || isCardView) && (<div className="bloghome__posts-list">
                <BlogPostItems items={items}/>
              </div>)}
              {isGridView && (<div className="bloghome__posts-grid">
